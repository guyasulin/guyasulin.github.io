(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BookShelfComponent = /** @class */ (function () {
                function BookShelfComponent(searchService) {
                    this.searchService = searchService;
                }
                BookShelfComponent.prototype.ngOnInit = function () {
                };
                BookShelfComponent.prototype.pageEvent = function (event) {
                    var _this = this;
            ...
            BookShelfComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BookComponent = /** @class */ (function () {
                ...
                BookComponent.prototype.openDialogBook = function () {
                    var dialogRef = this.dialog.open(_popup_book_details_book_details_component__WEBPACK_IMPORTED_MODULE_2__["BookDetailsComponent"], {
                        width: '400px',
                        data: this.book,
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HomeComponent = /** @class */ (function () {
                ...
                HomeComponent.prototype.goSearchPage = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var ImageLinks = /** @class */ (function () {
                function ImageLinks() {
                }
                return ImageLinks;
            }());
            var VolumeInfo = /** @class */ (function () {
                function VolumeInfo() {
                }
                return VolumeInfo;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BookDetailsComponent = /** @class */ (function () {
                function BookDetailsComponent(dialogRef, book, wishlistService) {
                ...
                BookDetailsComponent.prototype.onNoClick = function () {
                ...
                BookDetailsComponent.prototype.saveBook = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SearchBarComponent = /** @class */ (function () {
                ...
                SearchBarComponent.prototype.searchBook = function () {
                    var _this = this;
                    setTimeout(function () {
                        if (!_this.bookName) {
                            _this.books = [];
                            ...
                            _this.searchService.getBooks(_this.bookName)
                                .subscribe(function (res) {
                                _this.books = res.items;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SearchService = /** @class */ (function () {
                ...
                SearchService.prototype.getBooks = function (params, pageNumber) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var WishlistService = /** @class */ (function () {
                ...
                WishlistService.prototype.addWishlist = function (book) {
                    if (this.isBookExist(book) == false) {
                        this.wishlist.push(book);
                    }
                };
                WishlistService.prototype.deleteWishlist = function (book) {
                    for (var i = 0; i < this.wishlist.length; i++) {
                        var element = this.wishlist[i];
                ...
                WishlistService.prototype.isBookExist = function (book) {
                    return this.wishlist.some(function (x) {
                        if (x.id == book.id) {
                            return true;
                        }
                        else {
